...
<body>
  <div class="review-wrap">
    ...
    <div class="product-box">
			<div class="product-img">
				<c:choose>
					<c:when test="${not empty prdImg}">
						<img src="<%= ctxPath %><c:out value='${prdImg}'/>" alt="상품 이미지">
					</c:when>
					<c:otherwise>
			...
			<div class="product-meta">
				<p class="product-name">
					<c:out value="${prdName}" default="상품명" />
				</p>

				<div class="product-sub">
					<span class="badge"> <i class="fa-solid fa-won-sign"></i> 가격
    ...
    <form id="myform" method="post" action="<%= ctxPath %>/my_info/review_write_end.lp">
      ...
      <div class="review-textarea-wrap">
        <textarea id="reviewContents" name="reviewContents"
          maxlength="100"
  ...
  <script>
    document.querySelectorAll('input[name="reviewStar"]').forEach(radio=>{
