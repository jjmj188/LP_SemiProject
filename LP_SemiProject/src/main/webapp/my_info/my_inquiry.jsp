...
<jsp:include page="/WEB-INF/header1.jsp"></jsp:include>
  ...
  <div class="mypage-container">
    ...
    <aside class="mypage-menu">
      <h3>마이페이지</h3>
      <a href="<%= ctxPath%>/my_info.html">프로필 수정</a>
      <a href="<%= ctxPath%>/my_info/my_inquiry.jsp" class="active">문의내역</a>
      <a href="<%= ctxPath%>/my_info/my_wish.jsp" >찜내역</a>
      <a href="<%= ctxPath%>/my_info/my_order.jsp">구매내역</a>
      <a href="<%= ctxPath%>/my_info/my_taste.jsp">취향선택</a>
    </aside>
